(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,75254,e=>{"use strict";var a=e.i(71645);let o=e=>{let a=e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,a,o)=>o?o.toUpperCase():a.toLowerCase());return a.charAt(0).toUpperCase()+a.slice(1)},s=(...e)=>e.filter((e,a,o)=>!!e&&""!==e.trim()&&o.indexOf(e)===a).join(" ").trim();var i={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};let r=(0,a.forwardRef)(({color:e="currentColor",size:o=24,strokeWidth:r=2,absoluteStrokeWidth:t,className:n="",children:m,iconNode:d,...c},u)=>(0,a.createElement)("svg",{ref:u,...i,width:o,height:o,stroke:e,strokeWidth:t?24*Number(r)/Number(o):r,className:s("lucide",n),...!m&&!(e=>{for(let a in e)if(a.startsWith("aria-")||"role"===a||"title"===a)return!0})(c)&&{"aria-hidden":"true"},...c},[...d.map(([e,o])=>(0,a.createElement)(e,o)),...Array.isArray(m)?m:[m]])),t=(e,i)=>{let t=(0,a.forwardRef)(({className:t,...n},m)=>(0,a.createElement)(r,{ref:m,iconNode:i,className:s(`lucide-${o(e).replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase()}`,`lucide-${e}`,t),...n}));return t.displayName=o(e),t};e.s(["default",()=>t],75254)},37986,e=>{"use strict";let a="https://wa.me/5511910163467?text=Olá%20UPPER,%20vi%20o%20seu%20site%20e%20gostaria%20de%20um%20diagnóstico%20estratégico%20gratuito%20da%20minha%20empresa.",o=[{id:0,slug:"como-transformar-o-google-meu-negocio-numa-maquina-de-clientes",title:"Como transformar o Google Meu Negócio numa máquina de clientes",category:"SEO Local",date:"25 Fev, 2026",excerpt:"A maioria das empresas tem um perfil no Google Meu Negócio. Poucas sabem usar. Veja como transformar o seu perfil numa máquina de atração de clientes.",status:"published",content:`
...
[Quero meu diagn\xf3stico gratuito →](${a})
...
N\xe3o \xe9 falta de dedica\xe7\xe3o. \xc9 falta de sistema. ${o}
...
*Publicado por Upper Agency — Infraestrutura Digital para Empresas Locais.*
*SEO Local \xb7 GEO \xb7 WhatsApp Inteligente \xb7 Automa\xe7\xe3o com IA*
`},readTime:"11 min",imageUrl:"/images/blog/whatsapp-automation-header.png"}];e.s(["WHATSAPP_URL",0,a,"posts",0,o])}]);