...
import { posts, WHATSAPP_URL } from "@/lib/blog-data";
...
export default async function ServiceCityPage({ params }: { params: Promise<{ service: string; city: string }> }) {
  ...
  return (
    <div className="bg-zinc-950 min-h-screen">
      ...
      <section data-hero className="relative pt-32 pb-24 px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <h1 className="text-4xl md:text-8xl font-black text-white uppercase tracking-tighter leading-[0.9] max-w-5xl">
              {s.label} em <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto pt-4">
              <a 
                ...
                className="px-10 py-6 bg-emerald-500 text-zinc-950 rounded-full font-black uppercase text-xs tracking-[0.2em] flex items-center justify-center gap-3 hover:scale-105 transition-transform shadow-[0_0_40px_rgba(16,185,129,0.4)]"
              >
      ...
      <section className="py-24 px-8 border-t border-zinc-900 bg-zinc-900/10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-emerald-500 block">Mercado Local</span>
              <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter leading-tight">
                Oportunidade Digital <br /> em <span className="text-emerald-500">{cityName}.</span>
              </h2>
            </div>
            ...
            <div className="grid gap-4">
              {c.highlights.map((highlight, i) => (
                <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-zinc-900/50 border border-zinc-800/50">
                  ...
                  <span className="text-white text-[11px] font-black uppercase tracking-widest">{highlight}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="relative">
            ...
            <div className="relative bg-zinc-900 border border-zinc-800 rounded-[3rem] p-12 space-y-8 overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <MapPin size={120} className="text-emerald-500" />
              </div>
              <h3 className="text-2xl font-black text-white uppercase tracking-tighter">Presença Regional</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {c.neighborhoods.map((n) => (
                    <span key={n} className="px-4 py-2 rounded-full bg-emerald-500/5 border border-emerald-500/10 text-emerald-500 text-[10px] font-black uppercase tracking-tighter">
                      {n}
                    </span>
                  ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            <div className="space-y-8 sticky top-32">
              <div className="space-y-4">
                <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-emerald-500 block">Estratégia</span>
              ...
              <div className="pt-4">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-emerald-500 text-[10px] font-black uppercase tracking-widest hover:gap-4 transition-all"
                >
            ...
            <div className="grid gap-6">
              {s.benefits.map((benefit, i) => (
                <div key={i} className="group p-8 rounded-[2.5rem] bg-zinc-900/30 border border-zinc-900 hover:border-emerald-500/20 transition-all">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-white font-black uppercase text-sm tracking-tight">{benefit.split(':')[0]}</h3>
      ...
      <section className="py-32 px-8 bg-zinc-900/20 border-t border-zinc-900">
        <div className="max-w-4xl mx-auto space-y-20">
          <div className="text-center space-y-4">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-emerald-500 block">FAQ</span>
            <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter">Dúvidas Frequentes em {cityName}</h2>
          </div>
          <div className="space-y-4">
      ...
      <section className="py-32 px-8 border-t border-zinc-900">
        <div className="max-w-6xl mx-auto relative">
          <div className="absolute -inset-20 bg-emerald-500/10 blur-[120px] rounded-full opacity-30" />
          <div className="relative bg-zinc-900 border border-zinc-800 rounded-[4rem] p-12 md:p-24 text-center space-y-12 overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-emerald-500 to-transparent" />
            <div className="w-24 h-24 rounded-[2rem] bg-emerald-500/10 flex items-center justify-center text-emerald-500 mx-auto">
              <MessageSquare size={48} />
            </div>
            <div className="space-y-6">
              <h2 className="text-4xl md:text-7xl font-black text-white uppercase tracking-tighter leading-tight">
                Vamos dominar <br /> <span className="text-emerald-500">{cityName} juntos?</span>
              </h2>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex px-16 py-8 bg-emerald-500 text-zinc-950 rounded-full font-black uppercase text-sm tracking-[0.2em] items-center gap-4 hover:scale-105 transition-transform shadow-[0_0_60px_rgba(16,185,129,0.4)]"
            >
