// Adicionar dentro de cada NicheServiceContent no niche-service-data.ts
// Estrutura: faq: { question: string; answer: string }[]
...
export const nicheFAQData: Record<string, Record<string, FAQItem[]>> = {
  ...
  clinicas: {
    ...
    "automacao-whatsapp": [
      ...
      },
      {
        ...
        answer: "O bot deve ser configurado para identificar palavras de urgência e acionar imediatamente o atendimento humano ou fornecer orientação para procurar pronto-socorro. Nunca deixar um caso urgente no fluxo automático sem saída."
      },
      {
  ...
  arquitetura: {
    ...
    "landing-page": [
      ...
      },
      {
        ...
        answer: "Sim, com destaque. Reconhecimentos externos são prova social de alto impacto no mercado de arquitetura. Uma menção em uma publicação especializada ou um prêmio regional aumenta significativamente a percepção de valor do escritório."
      }
    ]
  },
  ...
  veterinarios: {
    ...
    "landing-page": [
      ...
      },
      {
        ...
        answer: "Uma faixa de preço ou o valor da consulta inicial é útil para qualificar o lead. Procedimentos mais complexos podem indicar 'orçamento mediante avaliação'. Transparência no básico reduz perguntas repetitivas e filtra clientes sem perfil."
      },
      {
  ...
  petshops: {
    ...
    "landing-page": [
      {
        question: "O que não pode faltar na landing page de um pet shop para converter tutores?",
  ...
  restaurantes: {
    "seo-local": [
      ...
      },
      {
        ...
        answer: "Sim, diretamente. O Google Maps prioriza perfis com fotos de qualidade e quantidade. Além disso, fotos apetitosas são o principal fator de conversão — o cliente decide experimentar o restaurante primeiro com os olhos."
      },
      {
