        ...
        <div className="relative bg-zinc-900 border border-zinc-800 rounded-[2.5rem] p-8 md:p-12 shadow-2xl space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex justify-start">
              <div className="max-w-[80%] p-4 rounded-2xl bg-zinc-950 border border-zinc-900 text-zinc-400 text-xs leading-relaxed">
                "Olá! Vi sua empresa no Google. Vocês atendem por convênio?"
              </div>
            </div>
            <div className="flex justify-end">
              <div className="max-w-[80%] p-4 rounded-2xl bg-emerald-500 text-zinc-950 text-xs font-bold leading-relaxed shadow-[0_0_20px_rgba(16,185,129,0.2)]">
                "Olá! Sim, atendemos Unimed e Bradesco. Gostaria de ver os horários disponíveis para esta semana?"
              </div>
            </div>
            <div className="flex justify-start">
              <div className="max-w-[80%] p-4 rounded-2xl bg-zinc-950 border border-zinc-900 text-zinc-400 text-xs leading-relaxed">
            ...
            <div className="flex justify-end">
              <div className="max-w-[80%] p-4 rounded-2xl bg-emerald-500 text-zinc-950 text-xs font-bold leading-relaxed shadow-[0_0_20px_rgba(16,185,129,0.2)]">
                "Perfeito! Tenho vaga amanhã às 14h ou quarta às 10h. Qual prefere?"
              </div>
            </div>
          </div>
