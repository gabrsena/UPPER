      ...
      <div className="relative">
        ...
        <div className="relative bg-zinc-900 border border-zinc-800 rounded-[2.5rem] p-8 md:p-12 shadow-2xl space-y-8">
          ...
          <div className="space-y-4">
            {[
              { name: "Sua Empresa", score: 98, color: "bg-emerald-500" },
              { name: "Concorrente A", score: 65, color: "bg-zinc-800" },
              { name: "Concorrente B", score: 42, color: "bg-zinc-800" },
            ].map((item, i) => (
