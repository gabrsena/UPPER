...
const OldIphoneMockup = ({ children }: { children: React.ReactNode }) => {
  return (
    ...
    <section id="evolucao" className="py-24 md:py-32 px-8 bg-[#fdfaf3] border-y-2 border-[#2d2d2d]/10 relative overflow-hidden scroll-mt-20">
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        <div className="space-y-4 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-marker text-[#1a1a1a] uppercase tracking-tighter leading-[1.1]">
            <span className="pen-text">Chega de perder</span> <br />
            <span className="bg-[#d4f1f4] px-3 sketch-border rotate-[-1deg] inline-block mt-2 pen-text">clientes em {cityName || "sua região"}.</span>
          </h2>
        </div>
