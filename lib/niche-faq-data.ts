  ...
  dentistas: {
    ...
    "automacao-whatsapp": [
      ...
      },
      {
        ...
        answer: "Sim. O app padrão do WhatsApp Business tem automações básicas, mas sem IA e sem múltiplos atendentes. Para um sistema de qualificação e agendamento automático, a API oficial é necessária."
      },
      {
